...
export async function getServerSideProps(context) {
  ...
  //   console.log("🚀 ~ file: [slug].js:9 ~ getServerSideProps ~ query", query);
  //   console.log(
  //     "🚀 ~ file: [slug].js:14 ~ getServerSideProps ~ size",
  //     size,
  //     slug,
  //     style
  //   );
  ...
  console.log("🚀 ~ file: [slug].js:79 ~ getServerSideProps ~ prices", prices);

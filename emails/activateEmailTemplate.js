export const activateEmailTemplate = (to, url) => {
  ...
  <tr>
  <td align="center" style="padding:0;Margin:0;font-size:0px"><a target="_blank" href="https://zando.com" style="-webkit-text-size-adjust:none;-ms-text-size-adjust:none;mso-line-height-rule:exactly;text-decoration:underline;color:#134F5C;font-size:14px"><img class="adapt-img" src="https://wqqdng.stripocdn.email/content/guids/CABINET_c1dcb82c88b8c23f88cd2cc2e86dbb4e/images/logo.png" alt="zando" style="display:block;border:0;outline:none;text-decoration:none;-ms-interpolation-mode:bicubic" height="34" title="zando"></a></td>
  </tr>
  <tr>
